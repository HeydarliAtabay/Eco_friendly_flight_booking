...
export default function MostRecentFlightCard(props: CardInterface) {
    ...
    return (
        <Card style={styles.container}>
            <View style={{
                alignItems: 'flex-start', padding: 3, width: '40%', backgroundColor: GREEN,
                borderTopLeftRadius: 10, borderBottomRightRadius: 10, borderBottomWidth: 1, borderBottomColor: 'black',
                borderRightWidth: 1, borderRightColor: 'black', borderTopWidth: 0
            }}>
                <Text style={{ fontSize: 15, textAlign: 'center', marginLeft: 10, color: 'white' }}>{'Upcoming flight'}</Text>
            </View>
            <Card.Content style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                <View style={{ alignItems: 'center', flexDirection: 'row', marginTop: 5, justifyContent: 'flex-start' }}>
