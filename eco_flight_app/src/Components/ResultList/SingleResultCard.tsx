...
import { ECO, getLogoFromAirlineId } from "../../helpers/images";
...
import { selectFlight, selectFlightDetailedInfo } from "./ResultList.slice";
        ...
        <TouchableOpacity
          onPress={() => {
            if (props.flight !== undefined && user !== undefined) {
              ...
              props.navigation.navigate("Flight Class");
            }
          }}
        >
          <View style={{ display: "flex", flexDirection: "row" }}>
            <View style={{ alignItems: "flex-start" }}>
              <Image
                ...
                source={{ uri: getLogoFromAirlineId(props.flight.airline) }}
              />
            </View>
          ...
          <View style={styles.datetimeBox}>
            ...
            >
              ...
              >{`${props.flight.departure_airport_name} (${props.flight.departure_airport_code})`}</Text>
              <Text
                style={styles.airportNameTxt}
              >{`${props.flight.arrival_airport_name} (${props.flight.arrival_airport_code})`}</Text>
            </View>
          </View>
          <View
            style={{
