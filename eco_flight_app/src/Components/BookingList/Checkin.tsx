...
export default function Checkin() {
  const { selectedBookedFLight, showSeatSelection, checkinState } = useStore(
    ({ booking }) => booking
  );
  ...
  async function makeCheckIn() {
    if (checkinState) {
      setLoading(true);
      await API.updateCheckinInformation(checkinState, selectedBookedFLight?.id)
        .then(() => {
          //
        })
        .catch((e) => alert(e.message));
      await API.getBookedFlights(selectedBookedFLight?.user_id)
        .then((res) => {
                  ...
                  <View style={{ alignItems: "center", marginTop: 20 }}>
                    ...
                    <View>
                      ...
                      selectedBookedFLight.selected_class === null ? (
                        ...
                        selectedBookedFLight.selected_class !== null &&
                        selectedBookedFLight.selected_class === "ECONOM" ? (
                        <View style={[styles.class_card]}>
                          <View style={styles.card_header}>
                            ...
                            <Text style={styles.card_header_class}>
                              Economy Class
                            </Text>
                          </View>
                        ...
                        selectedBookedFLight.selected_class !== null &&
                        selectedBookedFLight.selected_class === "BUSINESS" ? (
                        <View style={[styles.class_card]}>
                          <View style={styles.card_header}>
                            <Text style={styles.card_header_price}>
                        ...
                        <View style={styles.class_card}>
                          <View style={styles.card_header}>
                            <Text style={styles.card_header_price}>
                              {
                                selectedBookedFLight?.flight_info
                                  .first_class_price
                              }
                              <Icon name="logo-euro" size={15} />
                            </Text>
