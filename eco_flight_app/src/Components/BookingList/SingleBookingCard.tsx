            ...
            <Card.Content style={{ display: 'flex', flexDirection: 'column' }}>
                ...
                >
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row' }}>
                        ...
                        <View style={{ marginLeft: 'auto' }}>
                            ...
                            >{props.flight.checkin_status === "DONE" ? 'Checked-id' :
                                props.flight.checkin_status === 'NOT' ? 'Not available' :
                                    'Check-in available'
                                }</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ alignItems: 'center', flexDirection: 'row', marginTop: 5, justifyContent: 'flex-end' }}>
                        ...
                        <Text style={{ fontSize: 13, color: props.flight.payment_status === "PAID" ? GREEN : 'red' }}>
                            {props.flight.payment_status === "PAID" ? "Paid" : 'Unpaid'}</Text>
                    </View>
