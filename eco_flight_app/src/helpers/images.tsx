...
export function getLogoFromAirlineId(airlineId: number) {
    if (airlineId === 1) return 'https://api-ninjas.com/images/airline_logos/ryanair.jpg'
    if (airlineId === 2) return 'https://api-ninjas.com/images/airline_logos/wizz_air.jpg'
    if (airlineId === 3) return 'https://api-ninjas.com/images/airline_logos/turkish_airlines.jpg'
    if (airlineId === 4) return 'https://api-ninjas.com/images/airline_logos/lufthansa.jpg'
    if (airlineId === 5) return 'https://api-ninjas.com/images/airline_logos/easyjet.jpg'
    if (airlineId === 6) return 'https://api-ninjas.com/images/airline_logos/qatar_airways.jpg'
